...
#### TEST UPDATE_HEARTBEAT(Worker) ####
    ...
    def test_update_heartbeat_one_worker(self):
        ...
        previous_heartbeat = test_workers[0].heartbeat
        ...
        self.assertTrue(workers_list[0].heartbeat > checkpoint1
        and workers_list[0].heartbeat < checkpoint2 
        and workers_list[0].heartbeat > previous_heartbeat 
        and previous_heartbeat < checkpoint1)
